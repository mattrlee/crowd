...
$PAGE->set_url('/local/enlightencatalog/assign.php', array('id'=>$id));
...
<form id="assignform" method="post" action="<?php echo $PAGE->url ?>"><div>
  ...
  <table summary="" class="generaltable generalbox boxaligncenter" cellspacing="0">
    <tr>
      <td id="existingcell">
          <p><label for="removeselect"><?php print_string('currentcohorts', 'local_enlightencatalog'); ?></label></p>
      ...
      <td id="potentialcell">
          <p><label for="addselect"><?php print_string('potcohorts', 'local_enlightencatalog'); ?></label></p>
