...
$PAGE->set_url('/local/crowd/assign_category.php', array('id'=>$id));
...
<form id="assignform" method="post" action="<?php echo $PAGE->url ?>"><div>
  ...
  <table summary="" class="generaltable generalbox boxaligncenter" cellspacing="0">
    <tr>
      <td id="existingcell">
          <p><label for="removeselect"><?php print_string('currentcats', 'local_crowd'); ?></label></p>
      ...
      <td id="potentialcell">
          <p><label for="addselect"><?php print_string('potcats', 'local_crowd'); ?></label></p>
